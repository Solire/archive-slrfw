...
$.fn.spShow = function(){
    $(this).css({
        top: button.offset().top + options.buttonHeight + 10, 
        left: button.parent().offset().left
        }).slideDown(50);
...
switcherpane.find('a').hover(
    function(){
        updateCSS( $(this).attr('href') );
    }
);

switcherpane.mouseleave(
    function(){
...
button.css(button_default)
    ...
    .addClass("ui-corner-all fg-menu-content fg-menu-current ui-widget-content ui-helper-clearfix")
    .find('ul').css({
        listStyle: 'none',
        margin: '0',
        padding: '0',

...
//        $this->_debug();
    ...
    public function getCurrentPage() {
        if ($this->_currentPage > $this->_nbPages) { // Si la valeur de $pageActuelle (le numéro de la page) est plus grande que $nombreDePages...
    ...
    public function getPaginationArray() {
        ...
        for ($i = 1; $i <= $this->_nbPages; $i++) { //On fait notre boucle
            ...
            if ($i == $this->_currentPage) { //Si il s'agit de la page actuelle...
                ...
                $pages[] = array("num" => $i, "href" => $href . $pageRequest . $i, "current" => false);
            }
        }
        return $pages;
    }
